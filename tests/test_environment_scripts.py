...
def test_render_activate_and_deactivate_scripts_ps1(
    ...
    # activate
    assert render_activate_script(single_values, "ps1") == textwrap.dedent("""\
            # This file was generated by conda-devenv. Any changes may be overwritten.
            function Add-Path {
                param( $Path )
            ...
            """).strip()
    assert render_activate_script(multiple_values, "ps1") == textwrap.dedent("""\
            # This file was generated by conda-devenv. Any changes may be overwritten.
            function Add-Path {
                param( $Path )
                $env:PATH="$Path;$env:PATH"
    ...
    # deactivate
    assert render_deactivate_script(single_values, "ps1") == textwrap.dedent("""\
            # This file was generated by conda-devenv. Any changes may be overwritten.
            ...
            """).strip()
    assert render_deactivate_script(multiple_values, "ps1") == textwrap.dedent("""\
            # This file was generated by conda-devenv. Any changes may be overwritten.
            function Remove-Path {
                param ( $Path )
                $env:PATH=($env:PATH.split(';') | Where-Object{$_ -ne $Path}) -join ';'
