...
def main(args=None):
    ...
    parser.add_argument("--print", help="Prints the rendered file as will be sent to conda-env to stdout and exits.", action="store_true")
    parser.add_argument("--print-full", help="Similar to --print, but also includes the 'environment' section.", action="store_true")
